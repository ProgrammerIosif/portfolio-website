      ...
      <div className="max-xl:hidden flex gap-20 mb-5 mx-5">
        <div className="flex flex-col justify-center w-max">
          ...
          <div className='flex gap-4 pt-5 items-center'>
            ...
            <a href='https://www.linkedin.com/in/iosif-ioan-buliga-43a070272/' target='_blank'>
              <svg viewBox="0 0 128 128" className='w-10 hover:-translate-y-1 transition-all hover:animate-pulse'>
        ...
        <img id='profileImg' src={profileImg} height='450' width='450' className='rounded-full'/>
      </div>
      {/*mobile*/}
      <div className='xl:hidden flex flex-col items-center mb-20 mt-1'>
        <img id='profileImg' src={profileImg} height='300' width='300' className='rounded-full'/>
