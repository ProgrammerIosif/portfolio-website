...
export default function Projects() {
  return (
    <div id="projects" className="max-w-[3000px] select-none h-full text-[#38bdf8] pb-16 xs:pb-20 overflow-scroll
      ...
      <div className="flex flex-wrap gap-10 px-10 pb-10
        ...
        <h1 className="text-4xl uppercase w-full text-center font-semibold mt-5
                       xs:text-7xl
        ...
        {[{title:'Weather App',
          ...
          {title:'Presentation Site',
           ...
           live:'https://programmeriosif.github.io/calculatorul'}].map(project =>
            <div className='group relative overflow-hidden border border-[#38bdf8] rounded-xl min-h-fit aspect-[1920/1080]'>
