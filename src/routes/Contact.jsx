      ...
      <div className="grid gap-8 2xl:gap-20 pb-24 lg:grid-cols-2">
        <div className="flex flex-col gap-10">
          ...
          <a href='mailto:iosifioan.buliga@gmail.com' className="group flex gap-3 items-center">
            <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" version="1.1" viewBox="0 0 29 29" xml:space="preserve" className='w-8 xs:w-12 group-hover:-translate-y-1 transition-all group-hover:animate-pulse'>
