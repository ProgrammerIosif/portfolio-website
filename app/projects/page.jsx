      ...
      <div id="projects" className="max-w-[3000px] h-full text-accent pb-16 xs:pb-20 overflow-auto
        ...
        <div className="flex flex-wrap gap-10 px-10 pb-10 md:max-lg:px-24
          ...
          {[{title:'BeatsXchange',
            ...
            live:'https://beatsxchange.vercel.app'},
            ...
            {title:'Weather App',
             ...
             live:'https://weather-app-eta-tan.vercel.app'}].map(project =>
              <div className='group lg:max-w-[32rem] relative overflow-hidden border border-accent rounded-xl min-h-fit aspect-[1920/1080]'>
                ...
                <div className='absolute uppercase text-2xl font-semibold -bottom-full left-12 group-hover:bottom-32 group-active:bottom-32 transition-all duration-500 z-20'>
                  {project.title}
                </div>
                <a href={project.repo} target='_blank'>
                  <div className='absolute -bottom-full left-12 group-hover:bottom-20 group-active:bottom-20 transition-all duration-700 z-20 flex items-center gap-2 text-xl'>
                ...
                <a href={project.live} target='_blank'>
                  <div className='absolute -bottom-full left-12 group-hover:bottom-8 group-active:bottom-8 transition-all duration-1000 z-20 flex items-center gap-2 text-xl'>
