...
export default function Blog() {
  ...
  return (
    <>
      <PageTransition/>
      <div id="blog" className='text-primary overflow-auto w-full'>
        <div className="mx-auto max-w-4xl px-5 pb-20 md:pb-32">
          <h1 className="text-5xl uppercase text-center font-semibold text-accent my-4 md:my-10
                         xs:text-7xl
                         md:col-span-2 xl:col-span-3">Blog</h1>
          <ul>
            {posts.map(post =>
              <li className="group hover:bg-accent border border-accent rounded my-5">
